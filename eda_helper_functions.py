...
# Updated cat_univar_plots with corrected word cloud
...
# Now using cat_univar_plots(df, 'contract') will show unique values in the word cloud.
...
# Helper function for categorical heatmap (added/fixed here)
